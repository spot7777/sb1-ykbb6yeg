...
export function NavBar({ items, className }: NavBarProps) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 bg-navy-900/5 border border-gold-500/40 backdrop-blur-lg py-1 px-1 rounded-full shadow-lg">
        {items.map((item) => {
          ...
          return (
            <a
              ...
              className={cn(
                ...
                isActive && "bg-navy-900/20 text-gold-500",
              )}
            >
